...
/**
 * Viewport + overlay chrome on the left, docked scene/shop sidebar on the
 * right. The canvas is the product; the sidebar is retail + inspector.
 */
  ...
  return (
    <div className="relative flex h-dvh w-full overflow-hidden bg-canvas-bg">
      <div className="relative min-w-0 flex-1">
        <StudioViewport findings={findings} />
        <StudioTopBar
          available={available}
      ...
      <SceneDetails open={detailsOpen} onOpenChange={setDetailsOpen} />
    </div>
  );
}
